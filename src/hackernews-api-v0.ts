...
import { HackerNewsItemResponse, iAsk, iComment, iJob, iPoll, iPollOption, iStory } from "./types/hacker-news-api/Item";

const HACKER_NEWS_API_ENDPOINT_BASE_URL = "https://hacker-news.firebaseio.com/v0";


export const getItem = async (itemId: number) => {
    return axios.get<HackerNewsItemResponse>(`${HACKER_NEWS_API_ENDPOINT_BASE_URL}/item/${itemId}.json`)
